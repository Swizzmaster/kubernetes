...
git push -o merge_request.create -o merge_request.merge_when_pipeline_succeeds -o merge_request.remove_source_branch https://gitlab-ci-token:"$PROJECT_ACCESS_TOKEN"@gitlab.aws.dev/mattwon/ekskubernetespatches.git update_patches_base_version_"$MINOR_VERSION"
